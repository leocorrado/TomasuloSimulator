...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tomasulo

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tomasulo: ${OBJECTFILES}
...
${OBJECTDIR}/CommonDataBus.o: CommonDataBus.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/CommonDataBus.o CommonDataBus.cpp
...
${OBJECTDIR}/ReservationStation.o: ReservationStation.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReservationStation.o ReservationStation.cpp
